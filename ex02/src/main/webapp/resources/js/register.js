...
$(document).ready(function(){
	...
	$("input[type='submit']").on("click",function(e){
		e.preventDefault();	// submit 성질을 제거하는 기능, 이게 없으면 이거 아래의 문장을 실행하지 않음
		
		var str="";
		$(".uploadResult ul li").each(function(i,obj){	// for문 같은 기능
			var jobj = $(obj);
		...
		formObj.append(str).submit();	// append는 뒤에 추가적으로 붙이는 거
